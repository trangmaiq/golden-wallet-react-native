...
public class FingerprintDialog extends DialogFragment implements FingerprintHandler.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mFingerprintMessage = (TextView) v.findViewById(R.id.fingerprint_message);

        mFingerprintImage = (ImageView) v.findViewById(R.id.fingerprint_icon);
        if (this.dialogColor != 0) {
            mFingerprintImage.setColorFilter(Color.parseColor("#CF021B"));
        }
...
//        this.isAuthInProgress = false;
    ...
    private void handleUIError() {
        mFingerprintImage.setImageResource(R.drawable.ic_error);
        mFingerprintMessage.setText("FingerPrint not recognized. Please try again");
        mFingerprintMessage.setTextColor(Color.parseColor("#CF021B"));
    }
}
