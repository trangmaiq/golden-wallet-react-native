      ...
      <View>
        <Back
          style={[
            ...
            { position: 'absolute', zIndex: this.state.isFlipped ? 10 : 9, opacity: this.state.isFlipped ? 1 : 0 }
          ]}
        ...
        <Face
          style={[
            this.state.height > 0 && { height: this.state.height },
            this.state.width > 0 && { width: this.state.width },
            { position: 'absolute', zIndex: this.state.isFlipped ? 9 : 10, opacity: this.state.isFlipped ? 0 : 1 }
          ]}
          onLayout={(event) => {
            var { x, y, width, height } = event.nativeEvent.layout;
